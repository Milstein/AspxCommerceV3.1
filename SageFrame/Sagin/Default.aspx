<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="true" CodeFile="Default.aspx.cs" Inherits="SageFrame.Sagin_Default" Async="true" %>
            ...
            <asp:Literal ID="languageSetting" runat="server" EnableViewState="false"></asp:Literal>
                ...
                <div id="templateChangeWrapper" class="Off" style="top: -189px;">
                    <div class="templateChange">
                        <h6>
                            Theme</h6>
                        <asp:RadioButtonList viewstate="true" CssClass="sfTableThemeColor" runat="server" ID="rdTemplate"
