    ...
    private void Process()
    {
        try
        {
            ...
            if (Request.QueryString["oid"] != null)
                orderId = int.Parse(Request.QueryString["oid"]); if (Request.QueryString["iinfo"] != null)
                itemsInfo = Request.QueryString["iinfo"];
            #endregion
            if (Request.QueryString["cc"] != null)
                couponCode = Request.QueryString["cc"];
            if (Request.QueryString["cca"] != null)
                couponCodeApplied = int.Parse(Request.QueryString["cca"]);
            if (Request.QueryString["gcc"] != null)
                giftCardCode = Request.QueryString["gcc"];
