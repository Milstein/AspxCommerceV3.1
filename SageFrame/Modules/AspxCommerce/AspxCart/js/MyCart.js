            ...
            BindCartDetails: function (msg) {
                ...
                if (msg.d.length > 0) {
                    ...
                    $.each(msg.d, function (index, value) {
                        ...
                        cartElements += '<td>';
                        cartElements += '<a class="ClassDeleteCartItems" title="Delete" value="' + value.CartItemID + '" cartID="' + value.CartID + '"itemID="' + value.ItemID + '"sku="' + value.SKU + '" ><i class="i-delete"></i></a>';
                        cartElements += '</td>';
                        cartElements += '</tr>';
                    ...
                    $('.cssClassCartPicture img[title]').tipsy({
                        gravity: 'n'
                    });
