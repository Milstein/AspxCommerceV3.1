        ...
        var RewardPoints = function () {
            ...
            var init = function () {
                ...
                $("#chkUseRewardPoints").on("change", function () {
                    ...
                    //AspxCart.SetSessionValueForReward('RewardPoints', 0);
                    ...
                    itemSumTotal = cartCalculator.Calculate(); // parseFloat(eval(ItemSubtotal) - eval(oldd) - eval(cpn)).toFixed(2);
                    ...
                    if (this.checked) {
                        if (eval(totalRP) >= eval(minRedeem)) {
                            if (eval(itemSumTotal) > eval(totalRA)) {
                                ...
                                //                                $('.cssClassFormatCurrency').formatCurrency({
                                //                                    colorize: true,
                                //                                    region: '' + region + ''
                                //                                });
                            } else {
                ...
                $("#btnUsePoints").bind("click", function () {
                    ...
                    if (eval(totalRP) >= eval(minRedeem)) {
                        if (eval(itemSumTotal) > eval(totalRA)) {
                            ...
                            // AspxCart.SetSessionValueForReward('RewardPoints', totalRP);
                            $securepost("SSA", { k: 'RewardPoints', v: totalRP }, function () { }, null);
