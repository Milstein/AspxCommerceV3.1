        ...
        var cartCalculator = {
            ...
            getSubTotalWithTax: function () {
                ...
                $.each(cartCalculator.Items, function (index, item) {
                    ...
                    subtotal += item.Quantity * (item.Price + item.UnitTax);
                });
                return subtotal;
            },
        ...
        var CheckOut = {
                ...
                if (id != 0) {
                    for (var z = 0; z < tempUserAddresses.length; z++) {
                        if (parseInt(tempUserAddresses[z].AddressID) == parseInt(id)) {
                            ...
                            var ccode = '';
                            ccode = $('#hdnCountryList option:exactcontains(' + $.trim(address.Country) + ')').prop('value');
            ...
            GetShippinMethodsFromWeight: function (basketItemsDetail, shipAddress) {
                ...
                var shipToAddress = {
                    ...
                    ToCountry: $('#hdnCountryList option:exactcontains(' + $.trim(shipAddress.Country) + ')').attr('value'), ToCountryName: shipAddress.Country,
            ...
            Init: function () {
                ...
                if (AspxCommerce.utils.IsUserFriendlyUrl()) {
                    ...
                    register = 'sf/sfUser-Registration';
                    checkouturl = p.singleAddressCheckOutURL;
                }
                        ...
                        if ($(this).is(':checked') == true) {
                            $.ajax({
                                ...
                                success: function (msg) {
                                    ...
                                    CheckOut.SaveUserEmail(email, userModuleID, AspxCommerce.utils.GetPortalID(), AspxCommerce.utils.GetUserName(), p.userIP);
                                }
                            });
                        } else {
