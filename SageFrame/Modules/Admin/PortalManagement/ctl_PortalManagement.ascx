                                    ...
                                    <tr id="Tr2" runat="server">
                                        ...
                                        <td id="Td8" runat="server">
                                            <asp:DropDownList ID="ddlAvailablePortal" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlAvailablePortal_SelectedIndexChanged">
                                                 ...
                                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="Dynamic"  InitialValue="Choose One" ErrorMessage="Parent Portal Selection is required!"
                                                ControlToValidate="ddlAvailablePortal" ValidationGroup="PortalManagement"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
