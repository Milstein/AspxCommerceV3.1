    ...
    if (document.URL.toLocaleLowerCase().indexOf("admin/") != -1) {
        ...
        $(document).ajaxStart(function () {
            ...
            if ($("#fade").length < 1) {
                ...
                $divappend.prepend("<div id='fade'></div><div id='aspxcommereloading'><img id='loading' src='" + AspxCommerce.utils.GetAspxRootPath() + "images/aspx-loader.gif' title='AspxCommerce Loading...' alt='AspxCommerce Loading...'></div>");
                $("#fade").show();
            }
        });
...
function startLoader() {
        if ($("#fade").length < 1) {
            ...
            $divappend.prepend("<div id='aspxcommereloading'>" + "<img id='loading' src='" + AspxCommerce.utils.GetAspxRootPath() + "images/aspx-loader.gif' title='AspxCommerce Loading...' alt='AspxCommerce Loading...'>" + "</div><div id='fade'></div>");
            $("#fade").show();
        }
}
