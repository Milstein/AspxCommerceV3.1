...
namespace SageFrame.Framework
{
    ...
    public partial class PageBase : System.Web.UI.Page
    {
                            ...
                            using (StreamWriter sw = new StreamWriter(optimized_js_path))
                            {
                                ...
                                foreach (CssScriptInfo obj in lstJsColl)
                                {
                                    if (obj.AllowOptimization)
                                    {
                                        ...
                                        compressedjs = SetUpAjaxCall(obj.FileName, compressedjs,true);
                                        sw.Write("\n");
                                    ...
                                    else
                                    {
                                        ...
                                        uncompressedjs = SetUpAjaxCall(obj.FileName, uncompressedjs);
                ...
                if (LitSageScript != null)
                {
                    foreach (CssScriptInfo obj in lstJsColl)
                    {
                        ...
                        else
                        {
                            ...
                            js = SetUpAjaxCall(obj.FileName, js);
                        }
                        LitSageScript.Text += js;
                    }
                }
        ...
        /// <summary>
        /// Returns js ajax before send action
        /// </summary>
        /// <param name="jslibName">js library name</param>
        /// <param name="js">js to </param>
        /// <param name="isOptimized">is optimized or not!</param>
        /// <returns>Token added to the header</returns>
