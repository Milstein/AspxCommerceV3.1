...
namespace SageFrame.Web
{
    ...
    public static class PictureManager
    {
        ...
        /// <summary>
        /// Creates thumbnail for any image and returns 
        /// </summary>
        ...
        /// </summary>
        /// <param name="strImage">Local image full path upto image.</param>
        /// <param name="TargetHeight">Targeted  file height.</param>
        /// <param name="TargetWidth">Targeted  file width.</param>
        /// <param name="SavePath">Save Path.</param>
        ...
        /// </summary>
        /// <param name="strImage">Local image full path upto image.</param>
        /// <param name="Size">Targeted  file size.</param>
        /// <param name="SavePath">Save Path.</param>
        ...
        /// <param name="fileName">The new image name.</param>
        /// <param name="quality">Quality of the new image.</param>
        ...
        /// <summary>
        /// Calculates the Codec information of the image.
        /// </summary>
        ...
        /// <summary>
        /// Calculates the Codec Encoder information of the image.
        /// </summary>
