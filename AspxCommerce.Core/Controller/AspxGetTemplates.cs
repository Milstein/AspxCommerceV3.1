...
namespace AspxCommerce.Core
{
    public class AspxGetTemplates
    {
        ...
        private static StringBuilder scriptResultGrid()
        {
            ...
            gridTemp.Append("</div>");
            gridTemp.Append("<div class=\"cssGridDyanamicAttr\"></div>");
            ...
            gridTemp.Append("<input type=\"hidden\" name=\"itemwish\" value=\"${itemID},${JSON2.stringify(sku)},this\"></div>");           
        ...
        private static StringBuilder scriptResultList()
        {
            ...
            //scriptListTemp.Append("<p class=\"cssClassFeaturedBg cssClassFeaturedBg_${itemID}\">");
            //scriptListTemp.Append("<span class=\"sfLocale\">" + getLocale("FEATURED") + "</span></p>");
            ...
            scriptListTemp.Append("<span class=\"cssRegularPrice_${itemID} cssClassFormatCurrency\">${parseFloat(listPrice).toFixed(2)}</span>");
            scriptListTemp.Append("</span>");
            scriptListTemp.Append("</p>");
            ...
            scriptListTemp.Append("</span>");
            scriptListTemp.Append("</p>");
            scriptListTemp.Append("<div class=\"cssListDyanamicAttr\"></div>");
            scriptListTemp.Append("<div class=\"cssClassViewDetailsAddtoCart\">");
            //scriptListTemp.Append("<div class=\"sfButtonwrapper\">");
            //scriptListTemp.Append("<a href=\"${aspxRedirectPath}item/${sku}${pageExtension}\">");
            //scriptListTemp.Append("<span class=\"sfLocale\">" + getLocale("View Details") + "</span></a>");
            //scriptListTemp.Append("</div>");
            ...
            scriptListTemp.Append("<input type=\"hidden\" name=\"itemwish\" value=\"${itemID},${JSON2.stringify(sku)},this\"></div>");           
            scriptListTemp.Append("</div>");
            //scriptListTemp.Append("<div class=\"cssClassClear\">");
            //scriptListTemp.Append("</div>");
            scriptListTemp.Append("</div>");
            scriptListTemp.Append("</div>");          
